...
function download(url, filepath, onError, onDone, onProgress, auth) {
...
module.exports = function(url, option = {}) {
    ...
    let auth = option.auth || defaultOption.auth;
    return download(url, filepath, onError, onDone, onProgress, auth);
};
